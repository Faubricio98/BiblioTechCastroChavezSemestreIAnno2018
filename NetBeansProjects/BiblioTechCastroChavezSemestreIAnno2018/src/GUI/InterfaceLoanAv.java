 ...
 * @author faubricioch
 */
public class InterfaceLoanAv extends javax.swing.JFrame {

    /**
     * Creates new form Loan
     */
    DateFormat df= DateFormat.getDateInstance();
    public InterfaceLoanAv() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(validaRN()==1 && actionCombo.getSelectedIndex()==0){
            try {
                ...
                Logger.getLogger(InterfaceLoanAv.class.getName()).log(Level.SEVERE, null, ex);
            }
        }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfaceLoanAv.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfaceLoanAv().setVisible(true);
            }
        });
    }
